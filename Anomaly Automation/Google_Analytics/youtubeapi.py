...
CLIENT_SECRETS_FILE = "client_secret_youtube.apps.googleusercontent.com.json"
...
TOKEN_FILE_NAME = 'credentialsYT.dat'
...
parser = OptionParser();
parser.add_option("--metrics", dest="metrics", help="Report metrics", default="views,comments,favoritesAdded,favoritesRemoved,likes,dislikes,shares");
parser.add_option("--dimensions", dest="dimensions", help="Report dimensions", default="video");
parser.add_option("--start-date", dest="start_date", help="Start date, in YYYY-MM-DD format", default=one_week_ago);
